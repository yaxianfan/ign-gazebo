...
{
  /// \brief A component type that contains commanded angular velocity of an
  /// entity represented by ignition::math::Vector3d.
  using AngularVelocityCmd =
    Component<math::Vector3d, class AngularVelocityCmdTag>;
  IGN_GAZEBO_REGISTER_COMPONENT("ign_gazebo_components.AngularVelocityCmd",
      AngularVelocityCmd)
  ...
  IGN_GAZEBO_REGISTER_COMPONENT("ign_gazebo_components.WorldAngularVelocityCmd",
      WorldAngularVelocityCmd)
}
}
}
}

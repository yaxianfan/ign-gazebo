...
/// \brief Test DiffDrive2 system
class DiffDriveTest2 : public ::testing::TestWithParam<int>
{
...
/////////////////////////////////////////////////
TEST_P(DiffDriveTest2, SkidPublishCmd)
{
  // Start server
...
// Run multiple times
INSTANTIATE_TEST_CASE_P(ServerRepeat, DiffDriveTest2, ::testing::Range(1, 2));
